...
- [ ] 60 I still see ghost devices when the add-on restarts. Should we completely clear the persisted state out and start over? Also, should devices have a TTL so that when they haven't been seen in a while, they get removed automatically? Maybe a few hours 
- [ ] 61 I have still not addressed the different button sizes. Take a look at the buttons on the devices page as well as the buttons at the editor page. Depending on the color, they have different heights. Please ultra-think and make this tight and prevent future regressions of this. 
...
- [ ] 63 In the Queue tab, the Version column should be rendered in the same font and with the pin when needed as in the Devices tab. 