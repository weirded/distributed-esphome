/**
 * Grafana-style time-range picker (bug #49).
 *
 ...
 *
 * The presets use rolling `now - N` windows; the absolute panel lets the
 * user pick fixed calendar times via a day-picker + two `<input
 * type=time>` widgets. Not *exactly* Grafana's UI, but it carries the
 * same affordances without the 300 KB of dependencies theirs ships
 * with.
 */
